...
EVENT = "FOOD_TECH_EXPO_2026"
CATALOG_URL = "https://foodtechexpo.pl/katalog-wystawcow/"
DATA_URL = "https://foodtechexpo.pl/wp-content/uploads/exhibitor-catalogs/pwe-exhibitors.json"
...
BLOCKED = {
    ...
    "youtube.com", "tiktok.com", "foodtechexpo.pl", "ptakwarsawexpo.com",
...
def record_from_item(item):
    ...
    for product in products:
        value = product.get("name") or product.get("title", "") if isinstance(product, dict) else product
        if clean(value):
...
def enrich_domain(record):
    ...
    try:
        response = requests.post(
            ...
            json={"q": f'"{record["exhibitor_name"]}" official website Food Tech Expo 2026'},
            timeout=30,
        )
