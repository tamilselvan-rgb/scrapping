...
EVENT = "AFFAIRE_DE_CADEAUX_2026"
LIST_URL = "https://www.affaire-de-cadeaux.fr/liste-exposants"
...
BLOCKED = {
    ...
    "youtube.com", "wikipedia.org", "affaire-de-cadeaux.fr", "weyou-group.com",
    "yellowpages.com", "yelp.com", "10times.com", "eventseye.com",
    "pappers.fr", "equiphotel.com", "lotexpo.com", "objetrama.fr",
    "fashionnetwork.com", "tracesecritesnews.fr", "lejournaldesentreprises.com",
    "c-mag.fr", "seminairesbusiness.com", "salon-cbrand.com",
    "relations-publiques.pro", "guysavoy.com", "tripadvisor.fr",
    "influence-ce.fr", "lorientbretagnesudtourisme.fr",
    "faire.com", "rocketreach.co", "franceinfo.fr", "pagesjaunes.fr",
...
def enrich(record):
    ...
    try:
        response = requests.post(
            ...
            json={"q": f'"{record["exhibitor_name"]}" official website Affaire de Cadeaux 2026'},
            timeout=30,
        )
        response.raise_for_status()
        data = response.json()
...
def main():
    records = listing()
    print(f"Found {len(records)} official Affaire de Cadeaux 2026 exhibitors")
